...
我们**不**关心：单纯多模态对齐 benchmark 刷分。

## 该方向的 owner

- **小导师**：[占位](/members/lecturer-1/)
- **核心博士**：[占位](/members/phd-mid-1/) · [占位](/members/phd-mid-2/)
- **硕士 / 新生**：欢迎加入（视觉数据处理方向人手紧缺）

## 关键论文（外部）

- [视觉原语 (DeepSeek-VL)](/deepseek/visual-primitives/) —— 把 box / point 提升为推理原语
...
1. **第一步**：[视觉原语](/deepseek/visual-primitives/) —— 我们组关心问题的一个具体回答
