...
我们**不**关心：纯 prompt engineering 套路。

## 该方向的 owner

- **小导师**：[占位](/members/lecturer-1/)
- **核心博士**：[占位](/members/phd-senior-1/) · [占位](/members/phd-mid-2/)
- **硕士 / 新生**：欢迎加入
...
4. 多模态推理：视觉证据如何作为推理 step 的一部分？（参见 [视觉原语](/deepseek/visual-primitives/)）

## 推荐阅读路径（给新人）

1. **第一步**：词典 [GRPO](/concepts/grpo/) —— DeepSeek-R1 的核心算法
2. **第二步**：DeepSeek-R1 原论文（待补解读）
3. **第三步**：[视觉原语](/deepseek/visual-primitives/) —— 多模态推理的一个具体实例
4. **第四步**：从 GSM8K / MATH / AIME 一类 benchmark 上手复现一个简化版

## 该主线的"组内立场"

> 占位。例：我们更关心**推理过程的可解释性 + 可控性**，而不是单纯刷 benchmark。
